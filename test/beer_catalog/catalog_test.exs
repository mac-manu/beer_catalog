defmodule BeerCatalog.CatalogTest do
  ...
  describe "beers" do
    ...
    @valid_attrs %{brand: "some brand", origin: "some origin", quantity: 42, style: "some style", "—-no-context": "some —-no-context", "—-no-schema": "some —-no-schema"}
    @update_attrs %{brand: "some updated brand", origin: "some updated origin", quantity: 43, style: "some updated style", "—-no-context": "some updated —-no-context", "—-no-schema": "some updated —-no-schema"}
